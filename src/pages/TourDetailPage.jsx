...
export default function TourDetailPage() {
    ...
    const { tour, loading, error } = useTour(id, language);
    const { t } = useLanguage();
    ...
    if (tourImages.length > 0) {
        ...
        places.length > 0 &&
        places[0].place_photos &&
        places[0].place_photos.length > 0
    ) {
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <h1 style={{ marginBottom: 16 }}>{tour.name}</h1>
                    ...
                    {tour.company && (
                        ...
                        >
                            ...
                            <Link
                                to={`/company/${encodeURIComponent(tour.company)}`}
